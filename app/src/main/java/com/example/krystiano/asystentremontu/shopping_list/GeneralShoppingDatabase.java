...
//       public List<ShoppingListConfig> historyList;
//        @OneToMany(methods = {OneToMany.Method.ALL},variableName = "historyList")
//        public List<ShoppingListConfig> getHistoryList(){
//            if(historyList==null || historyList.isEmpty()){
//                historyList = SQLite.select()
//                        .from(ShoppingListConfig.class)
//                        .queryList();
//            }
//            return historyList;
//        }
